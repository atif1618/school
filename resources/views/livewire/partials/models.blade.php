                    ...
                    <div class="timeline timeline-border-dashed">
                        ...
                        <div class="timeline-item">
                            ...
                            <div class="timeline-content mb-10 mt-n1">
                                ...
                                <div class="mb-5 pe-3">
                                    <!--begin::Title-->
                                    <a href="javascript:;" class="fs-5 fw-semibold text-gray-800 text-hover-primary mb-2">3 New Incoming Project Files:</a>
                                    <!--end::Title-->
                                    <!--begin::Description-->
                                    <div class="d-flex align-items-center mt-1 fs-6">
                                        <!--begin::Info-->
                                ...
                                <div class="overflow-auto pb-5">
                                    <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-5">
                                        ...
                                        <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                            ...
                                            <div class="ms-1 fw-semibold">
                                                <!--begin::Desc-->
                                                <a href="javascript:;" class="fs-6 text-hover-primary fw-bold">Client UAT Testing Results</a>
                                                <!--end::Desc-->
                                                <!--begin::Number-->
                                        ...
                                        <div class="d-flex flex-aligns-center">
                                            ...
                                            <div class="ms-1 fw-semibold">
                                                <!--begin::Desc-->
                                                <a href="javascript:;" class="fs-6 text-hover-primary fw-bold">Finance Reports</a>
                                                <!--end::Desc-->
                                                <!--begin::Number-->
                            ...
                            <div class="timeline-content mb-10 mt-n1">
                                ...
                                <div class="pe-3 mb-5">
                                    ...
                                    <div class="fs-5 fw-semibold mb-2">Task
                                        <a href="javascript:;" class="text-primary fw-bold me-1">#45890</a>merged with
                                        <a href="javascript:;" class="text-primary fw-bold me-1">#45890</a>in “Ads Pro Admin Dashboard project:
                                    </div>
                                    <!--end::Title-->
                                    <!--begin::Description-->
                                    <div class="d-flex align-items-center mt-1 fs-6">
                                    ...
                                    <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-7">
                                        ...
                                        <div class="overlay me-10">
                                            ...
                                            <div class="overlay-layer bg-dark bg-opacity-10 rounded">
                                                <a href="javascript:;" class="btn btn-sm btn-primary btn-shadow">Explore</a>
                                            </div>
                                            <!--end::Link-->
                                        </div>
                                        <!--end::Item-->
                            ...
                            <div class="timeline-content mb-10 mt-n1">
                                ...
                                <div class="pe-3 mb-5">
                                    ...
                                    <div class="fs-5 fw-semibold mb-2">New case
                                        <a href="javascript:;" class="text-primary fw-bold me-1">#67890</a>is assigned to you in Multi-platform Database Design project
                                    </div>
                                    <!--end::Title-->
                                    <!--begin::Description-->
                                    <div class="overflow-auto pb-5">
                                ...
                                <div class="overflow-auto pb-5">
                                    ...
                                    <div class="notice d-flex bg-light-primary rounded border-primary border border-dashed min-w-lg-600px flex-shrink-0 p-6">
                                        ...
                                        <div class="d-flex flex-stack flex-grow-1 flex-wrap flex-md-nowrap">
                                            ...
                                            <!--end::Content-->
                                            <!--begin::Action-->
                                            <a href="javascript:;" class="btn btn-primary px-6 align-self-center text-nowrap">Proceed</a>
                                            <!--end::Action-->
                                        </div>
                                        <!--end::Wrapper-->
                                    </div>
                            ...
                            <div class="timeline-content mt-n1">
                                ...
                                <div class="pe-3 mb-5">
                                    ...
                                    <div class="fs-5 fw-semibold mb-2">New order
                                        <a href="javascript:;" class="text-primary fw-bold me-1">#67890</a>is placed for Workshow Planning & Budget Estimation
                                    </div>
                                    <!--end::Title-->
                                    <!--begin::Description-->
                                    <div class="d-flex align-items-center mt-1 fs-6">
            ...
            <div class="card-header pe-5" id="kt_drawer_chat_messenger_header">
                ...
                <div class="card-title">
                    ...
                    <div class="d-flex justify-content-center flex-column me-3">
                        <a href="javascript:;" class="fs-4 fw-bold text-gray-900 text-hover-primary me-1 mb-2 lh-1">Brian Cox</a>
                        <!--begin::Info-->
                        <div class="mb-0 lh-1">
                ...
                <div class="card-toolbar">
                    ...
                    <div class="me-0">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-3" data-kt-menu="true">
                            ...
                            <!--begin::Menu item-->
                            <div class="menu-item px-3">
                                <a href="javascript:;" class="menu-link px-3" data-bs-toggle="modal" data-bs-target="#kt_modal_users_search">Add Contact</a>
                            </div>
                            <!--end::Menu item-->
                            <!--begin::Menu item-->
                            <div class="menu-item px-3">
                                <a href="javascript:;" class="menu-link flex-stack px-3" data-bs-toggle="modal" data-bs-target="#kt_modal_invite_friends">Invite Contacts
                            ...
                            <div class="menu-item px-3" data-kt-menu-trigger="hover" data-kt-menu-placement="right-start">
                                ...
                                <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="javascript:;" class="menu-link px-3" data-bs-toggle="tooltip" title="Coming soon">Create Group</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="javascript:;" class="menu-link px-3" data-bs-toggle="tooltip" title="Coming soon">Invite Members</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="javascript:;" class="menu-link px-3" data-bs-toggle="tooltip" title="Coming soon">Settings</a>
                                    </div>
                                    <!--end::Menu item-->
                                </div>
                                <!--end::Menu sub-->
                    ...
                    <div class="d-flex justify-content-start mb-10">
                        ...
                        <div class="d-flex flex-column align-items-start">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <!--begin::Details-->
                                <div class="ms-3">
                                    <a href="javascript:;" class="fs-5 fw-bold text-gray-900 text-hover-primary me-1">Brian Cox</a>
                        ...
                        <div class="d-flex flex-column align-items-end">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <div class="me-3">
                                    ...
                                    <a href="javascript:;" class="fs-5 fw-bold text-gray-900 text-hover-primary ms-1">You</a>
                                </div>
                                <!--end::Details-->
                                <!--begin::Avatar-->
                                <div class="symbol symbol-35px symbol-circle">
        ...
        <div class="card card-flush w-100 rounded-0">
                ...
                <div class="d-flex flex-stack">
                    ...
                    <div class="d-flex flex-column me-3">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <a href="javascript:;" class="btn btn-sm btn-light-success btn-icon-success btn-icon w-25px h-25px me-2">
                                <i class="ki-outline ki-minus fs-4"></i>
                            </a>
                            <a href="javascript:;" class="btn btn-sm btn-light-success btn-icon w-25px h-25px">
            ...
            <div class="card-footer">
                ...
                <div class="d-flex justify-content-end mt-9">
                    <a href="javascript:;" class="btn btn-primary d-flex justify-content-end">Pleace Order</a>
                </div>
                <!--end::Action-->
            </div>
            <!--end::Card footer-->
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                    ...
                    <div class="text-center mb-13">
                        ...
                        <div class="text-muted fw-semibold fs-5">If you need more info, please check out
                            <a href="javascript:;" class="link-primary fw-bold">FAQ Page</a>.
                        </div>
                        <!--end::Description-->
                    </div>
                    <!--end::Heading-->
                        ...
                        <div class="mh-300px scroll-y me-n7 pe-7">
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <!--begin::Details-->
                                    <div class="ms-5">
                                        <a href="javascript:;" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Emma Smith</a>
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <!--begin::Details-->
                                    <div class="ms-5">
                                        <a href="javascript:;" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Melody Macy</a>
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <!--begin::Details-->
                                    <div class="ms-5">
                                        <a href="javascript:;" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Max Smith</a>
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <!--begin::Details-->
                                    <div class="ms-5">
                                        <a href="javascript:;" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Sean Bean</a>
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <!--begin::Details-->
                                    <div class="ms-5">
                                        <a href="javascript:;" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Brian Cox</a>
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <!--begin::Details-->
                                    <div class="ms-5">
                                        <a href="javascript:;" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Mikaela Collins</a>
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <!--begin::Details-->
                                    <div class="ms-5">
                                        <a href="javascript:;" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Francis Mitcham</a>
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <!--begin::Details-->
                                    <div class="ms-5">
                                        <a href="javascript:;" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Olivia Wild</a>
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <!--begin::Details-->
                                    <div class="ms-5">
                                        <a href="javascript:;" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Neil Owen</a>
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <!--begin::Details-->
                                    <div class="ms-5">
                                        <a href="javascript:;" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Dan Wilson</a>
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <!--begin::Details-->
                                    <div class="ms-5">
                                        <a href="javascript:;" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Emma Bold</a>
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <!--begin::Details-->
                                    <div class="ms-5">
                                        <a href="javascript:;" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Ana Crown</a>
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <!--begin::Details-->
                                    <div class="ms-5">
                                        <a href="javascript:;" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Robert Doe</a>
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <!--begin::Details-->
                                    <div class="ms-5">
                                        <a href="javascript:;" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">John Miller</a>
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <!--begin::Details-->
                                    <div class="ms-5">
                                        <a href="javascript:;" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Lucy Kunic</a>
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <!--begin::Details-->
                                    <div class="ms-5">
                                        <a href="javascript:;" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Ethan Wilder</a>
                ...
                <div class="modal-body pt-0 pb-15 px-5 px-xl-20">
                    ...
                    <div class="mb-13 text-center">
                        ...
                        <div class="text-muted fw-semibold fs-5">If you need more info, please check
                            <a href="javascript:;" class="link-primary fw-bold">Pricing Guidelines</a>.
                        </div>
                    </div>
                    <!--end::Heading-->
                    <!--begin::Plans-->
                            ...
                            <div class="col-lg-6 mb-10 mb-lg-0">
                                ...
                                <div class="nav flex-column">
                                    ...
                                    <label class="nav-link btn btn-outline btn-outline-dashed btn-color-dark btn-active btn-active-primary d-flex flex-stack text-start p-6 mb-6" data-bs-toggle="tab" data-bs-target="#kt_upgrade_plan_custom">
                                        ...
                                        <!--begin::Price-->
                                        <div class="ms-5">
                                            <a href="javascript:;" class="btn btn-sm btn-success">Contact Us</a>
                                        </div>
                                        <!--end::Price-->
                                    </label>
                                    <!--end::Tab link-->
                        ...
                        <div class="py-5">
                            ...
                            <div data-kt-search-element="suggestions">
                                ...
                                <div class="mh-375px scroll-y me-n7 pe-7">
                                    <!--begin::User-->
                                    <a href="javascript:;" class="d-flex align-items-center p-3 rounded bg-state-light bg-state-opacity-50 mb-1">
                                        <!--begin::Avatar-->
